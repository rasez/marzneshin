...
client_type_mime_type = {
    ...
    "ikev2": "application/x-apple-aspen-config",
    "l2tp": "text/plain",
    "clash-meta": "text/yaml",
    "clash": "text/yaml",
    "xray": "application/json",
...
def user_subscription_with_client_type(
    ...
    client_type: str = Path(
        regex="^(sing-box|clash-meta|clash|xray|v2ray|links|wireguard|openvpn|ikev2|l2tp)$"
    ),
):
    """
    Subscription by client type; v2ray, xray, sing-box, clash, clash-meta, wireguard, openvpn, ikev2, and l2tp formats supported
    """
